  ...
  return (
    <form onSubmit={handleSubmit} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll '>
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
        ...
        <button disabled={isAdding} type='submit' className='mt-4 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 cursor-pointer'>{isAdding ? 'Adding...' : 'Add Blog'}</button>
      </div>
    </form>
  ) 
}
